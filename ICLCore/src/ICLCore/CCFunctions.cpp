...
*/
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,Gray,RGB,subGraytoRGB,subSSEGraytoRGB,16)
    USE_SSE_CONVERT(icl8u,icl32f,Gray,RGB,subGraytoRGB,subSSEGraytoRGB,16)
    // USE_SSE_CONVERT(icl16s,icl16u,Gray,RGB,subGraytoRGB,subSSEGraytoRGB,16)
    USE_SSE_CONVERT(icl32f,icl8u,Gray,RGB,subGraytoRGB,subSSEGraytoRGB,16)
    // USE_SSE_CONVERT(icl32f,icl16u,Gray,RGB,subGraytoRGB,subSSEGraytoRGB,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,RGB,Gray,subRGBtoGray,subSSERGBtoGray,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,RGB,HLS,subRGBtoHLS,subSSERGBtoHLS,16)
    USE_SSE_CONVERT(icl8u,icl32f,RGB,HLS,subRGBtoHLS,subSSERGBtoHLS,16)
    // USE_SSE_CONVERT(icl16u,icl8u,RGB,HLS,subRGBtoHLS,subSSERGBtoHLS,16)
    // USE_SSE_CONVERT(icl16u,icl32f,RGB,HLS,subRGBtoHLS,subSSERGBtoHLS,16)
    USE_SSE_CONVERT(icl32f,icl8u,RGB,HLS,subRGBtoHLS,subSSERGBtoHLS,16)
    // USE_SSE_CONVERT(icl32f,icl16u,RGB,HLS,subRGBtoHLS,subSSERGBtoHLS,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,RGB,YUV,subRGBtoYUV,subSSERGBtoYUV,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,RGB,YUV,subRGBtoYUV,subSSERGBtoYUV,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,RGB,LAB,subRGBtoLab,subSSERGBtoLab,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,RGB,LAB,subRGBtoLab,subSSERGBtoLab,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,RGB,Chroma,subRGBtoChroma,subSSERGBtoChroma,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,RGB,Chroma,subRGBtoChroma,subSSERGBtoChroma,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,HLS,RGB,subHLStoRGB,subSSEHLStoRGB,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,HLS,RGB,subHLStoRGB,subSSEHLStoRGB,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,HLS,YUV,subHLStoYUV,subSSEHLStoYUV,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,HLS,YUV,subHLStoYUV,subSSEHLStoYUV,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,HLS,LAB,subHLStoLab,subSSEHLStoLab,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,HLS,LAB,subHLStoLab,subSSEHLStoLab,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,YUV,RGB,subYUVtoRGB,subSSEYUVtoRGB,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,YUV,RGB,subYUVtoRGB,subSSEYUVtoRGB,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,YUV,HLS,subYUVtoHLS,subSSEYUVtoHLS,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,YUV,HLS,subYUVtoHLS,subSSEYUVtoHLS,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,YUV,LAB,subYUVtoLab,subSSEYUVtoLab,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,YUV,LAB,subYUVtoLab,subSSEYUVtoLab,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,LAB,RGB,subLabtoRGB,subSSELabtoRGB,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,LAB,RGB,subLabtoRGB,subSSELabtoRGB,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,LAB,HLS,subLabtoHLS,subSSELabtoHLS,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,LAB,HLS,subLabtoHLS,subSSELabtoHLS,16)
    ...
    // USE_SSE_CONVERT(icl8u,icl16u,LAB,YUV,subLabtoYUV,subSSELabtoYUV,16)
    ...
    // USE_SSE_CONVERT(icl32f,icl16u,LAB,YUV,subLabtoYUV,subSSELabtoYUV,16)
  ...
  #undef CASE_LABEL
    ...
    template<class S> void cc_s(const Img<S> *src, ImgBase *dst, bool roiOnly){
      ...
      switch(dst->getDepth()){      //TODO depth macro
        ...
        case depth16u: cc_sd(src, dst->asImg<icl16u>(),roiOnly); break;
      ...
      switch(cc_available(src->getFormat(), dst->getFormat())){
        case ccAvailable:
          switch(src->getDepth()){ //TODO depth macro
            ...
            case depth16u: cc_s(src->asImg<icl16u>(),dst,roiOnly); break;
  ...
  #define ICL_INSTANTIATE_DEPTH(D)  case depth##D:                                                                          \
            switch(dst->getDepth()){                                                                                        \
              ...
              break;                                                                                                        \
              case depth16u: for(int i=0;i<n;i++){                                                                          \
                convertChannelROI(src->asImg<icl##D>(),i,src->getROIOffset(),src->getROISize(),                             \
                                  dst->asImg<icl16u>(),i,dst->getROIOffset(),dst->getROISize());                            \
              }                                                                                                             \
              break;                                                                                                        \
  ...
  #undef ICL_INSTANTIATE_DEPTH
    ...
    void for_copy_p4c4(const S *s0, const S *s1, const S *s2, const S *s3, D *dst, const D *dstEnd) {
      ...
      inline void sse_copy_p3c3(const icl8u *src0, const icl8u *src1, const icl8u *src2, icl16u *dst) {
        const icl8ux16 mask = icl32sx4(0x04010200, 0x0A080506, 0x0D0E0C09, 0x80808080);
        const __m128i vk0 = _mm_setzero_si128();
    ...
    void for_copy_p3c3(const icl8u *src0, const icl8u *src1, const icl8u *src2, icl16u *dst, icl16u *dstEnd) {
      icl16u *dstSSEEnd = dstEnd - 55;
    ...
    void for_copy_c4p4(const S *src, D *d0, D *d1, D *d2, D *d3, const D *dstEnd) {
      ...
      inline void sse_copy_c3p3(const icl8u *src, icl16u *dst0, icl16u *dst1, icl16u *dst2) {
        // this function can be improved with SSE4 using _mm_blendv_epi8;
        ...
        icl16ux16(v0).storeu(dst0);
        icl16ux16(v1).storeu(dst1);
        icl16ux16(v2).storeu(dst2);
      }
    ...
    void for_copy_c3p3(const icl8u *src, icl16u *d0, icl16u *d1, icl16u *d2, icl16u *dstEnd) {
      sse_for(src, d0, d1, d2, dstEnd, copy_c3p3, sse_copy_c3p3, 48, 16);
    }
  ...
  #define EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(TYPEA,TYPEB)                            \
    ...
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl16u,icl16u);
    ...
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl16u,icl8u);
    ...
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl16u,icl16s);
    //EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl16s,icl16s);
    ...
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(signed char,icl16u);
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl8u,icl16u);
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl16s,icl16u);
    //EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl16u,icl16u);
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl32s,icl16u);
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl32f,icl16u);
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl64f,icl16u);
    ...
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl16u,icl32s);
    //EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl32s,icl32s);
    ...
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl16u,icl32f);
    ...
    EXPLICIT_I2P_AND_P2I_TEMPLATE_INSTANTIATION(icl16u,icl64f);
