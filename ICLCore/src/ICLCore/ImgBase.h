...
namespace icl {
  namespace core{
    ...
    /** \section SEC1 Class
        ...
        void special_function_16u(Img16f* poImage){...}
        ...
        ...
        void generic_function(ImgBase *poImage){
           switch(poImage->getDepth()){
              ...
              case depth16u: special_function_8u(poImage->asImg<icl16u>());
              ...
        ...
        void generic_function(ImgBase *poImage){
           switch(poImage->getDepth()){
              ...
              case depth16u: template_function(poImage->asImg<icl16u>());
              ...
    ...
    **/
    class ICLCore_API ImgBase{
      ...
      /// convenience shortcut version for asImg<icl16u>()
      inline Img<icl16u> *as16u() { return asImg<icl16u>(); }
      ...
      /// convenience shortcut version for asImg<icl16u>()
      inline const Img<icl16u> *as16u() const { return asImg<icl16u>(); }
