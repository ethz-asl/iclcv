...
namespace icl {
  ...
  #undef ADD_CHANNEL
    ...
    template <>
    void Img<icl16u>::mirror(axis eAxis, int iChannel, const Point &oOffset, const Size &oSize) {
      ippiMirror_16u_C1IR(getROIData(iChannel,oOffset), getLineStep(), oSize, (IppiAxis) eAxis);
    }
    template <>
