...
namespace icl {
  namespace core{
    ...
    /// typedef for 16bit unsigend integer images \ingroup TYPES
    typedef Img<icl16u> Img16u;

    /// typedef for 32bit integer images \ingroup TYPES
    ...
    enum depth{
      ...
      depth64f = 5, /**< 64Bit floating point values */
      depthLast = depth64f
    };
